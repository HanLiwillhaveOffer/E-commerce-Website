...
<html>
 ...
 <!--  <tr><td><img width=60px height= 50px src="image/logo.jpg "></td></tr> -->
  ...
  <td><a href="<%=path%>/shopping"><img src="image/shopcart.jpg"></a></td>
   ...
   <div class="stylep2">
   <div style="font-family: cursive;font-size:xx-large; font-weight: bolder;"><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SUCCESS!<br/><br/><br/></div>
   <table width=80% border=0 bordercolor=black cellspan=0 height=500 align="center" margin-left=10px>
   <tr >
   <td > You have successfully deleted this item from your shopping cart!
 <a style="color: red" href = "<%=path %>/shopping">To my shoppingcart!<a/>
  <a style="color: red" href = "test.jsp">Continue to buy<a/>
</td>
   <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
   ...
   <div class="style3">
   <ul class="ulstyle2">
   <li style="font-family: cursive; color: white;" ><a href="page1.html"><img src="image/home.jpg"></a></li>
