...
<html>
 ...
 <!--  <tr><td><img width=60px height= 50px src="image/logo.jpg "></td></tr> -->
  ...
  <td><a href="<%=path%>/shopping"><img src="image/shopcart.jpg"></a></td>
   ...
   <div class="stylep2">
   <div style="font-family: cursive;font-size:xx-large; font-weight: bolder;"><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Give us your suggestions<br/><br/><br/></div>


  <form method="post" action="./newmessage">
	 <% ArrayList<Message> list=(ArrayList<Message>)session.getAttribute("list");  %>
	    	    
	<table class="message" border=1 align="center" width="80%" cellpadding="10px" style="font-family: cursive;">
     
     <tr><td width="35%">username</td><td>message</td></tr>
     <%  
	...
	<div style="margin-left: 150px">    
	    ...
	    if(username==null){%>
	    <a style="color: black;" href = "login.jsp">Please Login</a><br/><%}else{ %>
	    <%=username %><br/>
	    <%} %>  
	    <textarea cols="130" rows="10" name="message"></textarea>  <br/>   <br/> 
